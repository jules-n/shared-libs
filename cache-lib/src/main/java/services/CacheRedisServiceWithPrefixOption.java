...
@Service
@Log4j2
public class CacheRedisServiceWithPrefixOption<K, V> implements CacheService<K, V> {
    private final RedisTemplate<String, V> redisTemplate;
    private String prefix;

    public CacheRedisServiceWithPrefixOption(RedisTemplate<String, V> redisTemplate, String prefix) {
        this.redisTemplate = redisTemplate;
        this.prefix = prefix;
    }

    public CacheRedisServiceWithPrefixOption(RedisTemplate<String, V> redisTemplate) {
        this.redisTemplate = redisTemplate;
    }
